    ...
    <form action="{{ route('vehiculo.store') }}" method="POST">
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <input type="number" id="stock" name="stock" value="{{ old('stock') }}" placeholder="Ej: 5" min="0" required>
            </div>
        </div>
        <div class="form-group">
            <label for="precio">Precio (USD) <span class="req">*</span></label>
            <input type="number" id="precio" name="precio" value="{{ old('precio') }}" placeholder="Ej: 25000.00" min="0" step="0.01" required>
        </div>
        <div class="btn-group">
